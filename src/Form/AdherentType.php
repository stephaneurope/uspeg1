...

{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('born',DateTimeType::class,$this->getConfiguration("Né(e) le","Tapez la date de naissance "))
            ...
            ->add('lieut',TextType::class,$this->getConfiguration("Lieut","Tapez le lieut"))
            ...
            ->add('categoryArbitre',TextType::class,$this->getConfiguration("Catégory d'arbitre","Tapez la catégorie d'arbitre"))
